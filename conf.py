...
BLOG_AUTHOR = "J.Net"  # (translatable)
BLOG_TITLE = "What? Like it's hard?"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://jennetters.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://jennetters.github.io/"
BLOG_EMAIL = "jennette.reid@gmail.com"
BLOG_DESCRIPTION = "I too can build a thing."  # (translatable)
...
IMAGE_THUMBNAIL_FORMAT = '{name}.thumb{ext}'
